...
const CHARACTERS = {
  tanjiro: {
    ...
    impacts: {
      sword: 'assets/effects/hit_tanjiro_sword.png',
      kick: 'assets/effects/hit_tanjiro_kick.png',
      proj: 'assets/effects/hit_tanjiro_proj.png',
      block: 'assets/effects/hit_tanjiro_block.png',
    },
    ...
    swordPivotX: 20,
    swordPivotY: -10,
    vfxKick: 'assets/effects/vfx_kick_tanjiro.png',
  },
  nezuko: {
    id: 'nezuko',
    name: 'Nezuko',
    ...
    impacts: {
      sword: 'assets/effects/hit_nezuko_sword.png',
      kick: 'assets/effects/hit_nezuko_kick.png',
      proj: 'assets/effects/hit_nezuko_proj.png',
      block: 'assets/effects/hit_nezuko_block.png',
    },
    ...
    swordPivotX: 15,
    swordPivotY: -5,
    vfxKick: 'assets/effects/vfx_kick_nezuko.png',
  },
  zenitsu: {
    id: 'zenitsu',
    name: 'Zenitsu',
    ...
    impacts: {
      sword: 'assets/effects/hit_zenitsu_sword.png',
      kick: 'assets/effects/hit_zenitsu_kick.png',
      proj: 'assets/effects/hit_zenitsu_proj.png',
      block: 'assets/effects/hit_zenitsu_block.png',
    },
    ...
    swordPivotX: 18,
    swordPivotY: -8,
    vfxKick: 'assets/effects/vfx_kick_zenitsu.png',
  },
  inosuke: {
    id: 'inosuke',
    name: 'Inosuke',
    ...
    impacts: {
      sword: 'assets/effects/hit_inosuke_sword.png',
      kick: 'assets/effects/hit_inosuke_kick.png',
      proj: 'assets/effects/hit_inosuke_proj.png',
      block: 'assets/effects/hit_inosuke_block.png',
    },
    ...
    swordPivotX: 22,
    swordPivotY: -12,
    vfxKick: 'assets/effects/vfx_kick_inosuke.png',
  }
};
...
const Images = (() => {
  ...
  async function preloadAll() {
    ...
    for (const id of CHARACTER_ORDER) {
      ...
      promises.push(load(`aura_${id}`, `assets/effects/${id}_aura.png`));
      promises.push(load(`impact_${id}`, `assets/effects/${id}_impact.png`));
